...
public class ConditionalComplexityReportGenerator {
    ...
    public void addConditionalComplexityToReport(RichTextReport report) {
        ...
        report.addParagraph("The distribution of complexity of units (measured with McCabe index).", "margin-top: 12px; color: grey; font-size: 94%");
        ...
        report.addListItem("There are <a href='#' onclick=\"return downloadDataFile('text/units.txt')\">" + RichTextRenderingUtils.renderNumberStrong(unitsAnalysisResults.getTotalNumberOfUnits())
