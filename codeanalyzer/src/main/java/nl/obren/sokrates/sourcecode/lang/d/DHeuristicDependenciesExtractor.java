...
public class DHeuristicDependenciesExtractor extends HeuristicDependenciesExtractor {
    public static final String PACKAGE_PREFIX = "module ";
    ...
    public List<DependencyAnchor> extractDependencyAnchors(SourceFile sourceFile) {
        ...
        if (startIndexOfPackageName >= 0) {
            ...
            if (endIndexOfPackageName >= 0) {
                ...
                dependencyAnchor.getDependencyPatterns().add("[ ]*import .*" + packageName.replace(".", "[.]") + ";");
