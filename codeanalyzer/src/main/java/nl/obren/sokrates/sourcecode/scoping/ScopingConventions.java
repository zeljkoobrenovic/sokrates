...
public class ScopingConventions {
    ...
    private void addBuildAndDeploymentConventions() {
        ...
        buildAndDeploymentFilesConventions.add(new Convention(".*[.]vbproj", "", "VB project files"));
    ...
    private void addGeneratedConventions() {
        ...
        generatedFilesConventions.add(new Convention("// This file was generated by .*", "", "Generated files"));
