...
public class KotlinAnalyzer extends LanguageAnalyzer {
    ...
    private boolean isFunction(String line) {
        ...
        String prefixes = "override| open |abstract |protected |public| private |suspend ";
    ...
    public DependenciesAnalysis extractDependencies(List<SourceFile> sourceFiles, ProgressFeedback progressFeedback) {
        return new KotlinHeuristicDependenciesExtractor().extractDependencies(sourceFiles, progressFeedback);
    }
