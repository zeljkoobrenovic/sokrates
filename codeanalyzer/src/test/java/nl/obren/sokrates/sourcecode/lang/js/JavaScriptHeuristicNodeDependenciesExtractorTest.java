...
public class JavaScriptHeuristicNodeDependenciesExtractorTest {
    @Test
    public void extractDependenciesToTargetAnchor() throws Exception {
        JavaScriptHeuristicNodeDependenciesExtractor extractor = new JavaScriptHeuristicNodeDependenciesExtractor();
