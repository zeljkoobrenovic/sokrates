...
public class JavaExampleFragments {
    ...
    public final static String FRAGMENT_2 = "    /**\n" +
    ...
    public static final String FRAGMENT_2_CLEANED = "    private boolean validateURLPattern(String urlPattern) {\n" +
            "        if (urlPattern == null)\n" +
            "            return false;\n" +
            "        if (urlPattern.indexOf('\\n') >= 0 || urlPattern.indexOf('\\r') >= 0) {\n" +
            "            return false;\n" +
    ...
    public final static String FRAGMENT_3 = "    /**\n" +
    ...
    public final static String FRAGMENT_3_CLEANED = "    private void postWorkDirectory() {\n" +
            "        String workDir = getWorkDir();\n" +
            "        if (workDir == null || workDir.length() == 0) {\n" +
            "            String hostName = null;\n" +
            "            String engineName = null;\n" +
