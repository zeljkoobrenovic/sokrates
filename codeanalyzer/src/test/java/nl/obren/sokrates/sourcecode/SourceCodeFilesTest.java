...
public class SourceCodeFilesTest {
    ...
    public void createBroadScope() throws Exception {
        ...
        sourceCodeFiles.createBroadScope(Arrays.asList("java", "js"), new ArrayList<>(), new AnalysisConfig());
        ...
        sourceCodeFiles.createBroadScope(Arrays.asList("java", "js"), Arrays.asList(filter), new AnalysisConfig());
    ...
    public void shouldExclude() throws Exception {
        ...
        assertTrue(sourceCodeFiles.shouldExcludeFile(sourceFile, Arrays.asList(filter1), new AnalysisConfig()));
        assertFalse(sourceCodeFiles.shouldExcludeFile(sourceFile, Arrays.asList(filter2), new AnalysisConfig()));
        assertTrue(sourceCodeFiles.shouldExcludeFile(sourceFile, Arrays.asList(filter1, filter2), new AnalysisConfig()));
    }
