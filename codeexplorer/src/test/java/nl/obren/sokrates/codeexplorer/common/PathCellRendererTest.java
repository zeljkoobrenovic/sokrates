...
public class PathCellRendererTest {
    ...
    public void getPathPrefix() throws Exception {
        ...
        assertEquals(renderer.getPathPrefix(new File("/root/a/b/c/A.java")), getDefault().getSeparator() + "root" + getDefault().getSeparator() + "a" + getDefault().getSeparator() + "b" + getDefault().getSeparator() + "c" + "/");
